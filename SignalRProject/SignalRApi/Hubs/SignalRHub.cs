...
namespace SignalRApi.Hubs
{
	public class SignalRHub : Hub
	{
        ...
        public async Task SendStatistic()
		{
			...
			var value12=_orderService.TAcctiveOrderCount();
			await Clients.All.SendAsync("ReceiveAcctiveOrderCount", value12);
		...
		public async Task SendProgress()
		{
			...
			var value2 = _orderService.TAcctiveOrderCount();
			await Clients.All.SendAsync("ReceiveAcctiveOrderCount", value2);
